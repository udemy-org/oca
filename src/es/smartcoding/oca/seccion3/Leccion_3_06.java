...
public class Leccion_3_06 {
	...
	public static void main(String[] args) {
		...
		// 2014-01-22
		System.out.println("date5 plus 2 days: " + date5);
		date5 = date5.plusWeeks(1);
		// 2014-01-29
		System.out.println("date5 plus 1 week: " + date5);
		date5 = date5.plusMonths(1);
		// 2014-02-28
		System.out.println("date5 plus 1 month: " + date5);
		date5 = date5.plusYears(5);
		// 2019-02-28
		System.out.println("date5 plus 5 years: " + date5);
		...
		System.out.println("peridod4: " + period4);
